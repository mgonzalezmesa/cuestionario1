...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="article_text">
	    ...
	    <p class="meta"><?php _e( 'Por', 'honma' ); ?> <?php the_author(); ?>  | <?php the_time( get_option( 'date_format' ) ); ?> | <?php _e( 'Archivado en:', 'honma' ); ?> <?php the_category(', '); ?></p>
		<?php the_excerpt(); ?>
		<a href="<?php the_permalink(); ?>"><?php _e( 'Leer más', 'honma' ); ?></a>
	</div>
	<div class="clear"></div>
</article>
