			...
			<div class="container">
				<div class="footer_widgets columnwrapp clearfix">
					<!--<div class="column4">
						...
						<?php else : ?>	
							<aside class="widget">
								<h3 class="widget-title"><?php _e( 'Entradas recientes', "honma" ); ?></h3>
								<ul>
					...
					<!-- <div class="column4">
						...
						<?php else : ?>	
							<aside class="widget">
								<h3 class="widget-title"><?php _e( 'Nube de tags', "honma" ); ?></h3>
								<div class="tagcloud">
									<?php wp_tag_cloud(); ?>
								</div>
							</aside>
					...
					<div class="column4">
						...
						<?php else : ?>	
							<aside class="widget">
								<h3 class="widget-title"><?php _e( 'Páginas', "honma" ); ?></h3>
								<ul>
					...
					<div class="column4">
						...
						<?php else : ?>	
							<aside class="widget">
								<h3 class="widget-title"><?php _e( 'Categorías', "honma" ); ?></h3>
								<ul>
