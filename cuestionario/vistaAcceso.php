...
class vistaAcceso{
        ...
        <form  method="post" action="<?php echo "../cuestionario/index.php" ?>">
			...
			<div class="caja">   
                <select name="dificultad" style="background: #ffffff;border: none; font-size: 14px;height: 30px;padding: 5px;width: 270px;">
                <option value="facil">Fácil</option>
                <option value="normal">Normal</option>
                <option value="dificil">Difícil</option>
            </select>
                </div>
			 <!--<input style="padding:15px; width:40%;" type="submit" name="empezar" value="Empezar" class="boton"/>-->
             <button class="button" style="vertical-align:middle" name="empezar" value="Empezar"><span>EMPEZAR </span></button>
        </form>
		</div>
